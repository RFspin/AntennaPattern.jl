...
# creating surface 
θ1, φ1, r1 = createSurface(df[!, "θ[deg.]"], df[!, "φ[deg.]"], df[!, "|Dir.|[dBi]"], repeat_first_φ=true, θ_f = :deg, φ_f = :deg)
θ2, φ2, r2 = createSurface(deg2rad.(df[!, "θ[deg.]"]), deg2rad.(df[!, "φ[deg.]"]), df[!, "|Dir.|[dBi]"], repeat_first_φ=true)
θ3, φ3, r3 = createSurface(df[!, "θ[deg.]"], df[!, "φ[deg.]"], df[!, "|Dir.|[dBi]"], repeat_first_φ=false, θ_f = :deg, φ_f = :deg)
θ4, φ4, r4 = createSurface(deg2rad.(df[!, "θ[deg.]"]), deg2rad.(df[!, "φ[deg.]"]), df[!, "|Dir.|[dBi]"], repeat_first_φ=false)
